...
type RootStackParamList = {
  CheckerScreen: undefined;
  VoucherDetail: { voucherId: string; voucherData: Voucher };
  Profile: undefined;
  AuthLoading: undefined;
};

type CheckerScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'CheckerScreen'>;

interface CheckerScreenProps {
  navigation: CheckerScreenNavigationProp;
}
...
export default function CheckerScreen({ navigation }: CheckerScreenProps) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* Using the AppHeader component instead of the custom header */}
      <AppHeader 
