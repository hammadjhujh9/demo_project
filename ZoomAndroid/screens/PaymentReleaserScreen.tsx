...
type PaymentReleaserScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'PaymentReleasorScreen'>;

interface PaymentReleaserScreenProps {
  navigation: PaymentReleaserScreenNavigationProp;
}

export default function PaymentReleaserScreen({ navigation }: PaymentReleaserScreenProps) {
  ...
  const viewImage = (imageUrl: string | undefined) => {
    if (!imageUrl) {
...
const styles = StyleSheet.create({
  ...
  tabStyle: {
    // Add any custom styles for the tab bar
  },
  loadingContainer: {
    flex: 1,
